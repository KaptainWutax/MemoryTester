...
public class GuiMenu extends JFrame {
    ...
    private void initialize() {
        ...
        startButton.setBounds(buttonCenterX + buttonOffsetX, buttonCenterY + buttonOffsetY + 50, buttonWidth, buttonHeight);
        frame.getContentPane().add(startButton);

        JButton quitButton = new JButton("Quit");
        quitButton.setEnabled(true);
        quitButton.setBounds(buttonCenterX + buttonOffsetX, buttonCenterY + buttonOffsetY, buttonWidth, buttonHeight);
